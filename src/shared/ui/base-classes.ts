export const baseClasses: Record<string, string> = {
  ...
  input:
    'border rounded-sm shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 hover:shadow-md bg-gray-50 sm:text-base md:text-lg disabled:bg-gray-400',
  button:
    ' p-3 cursor-pointer text-base sm:text-lg md:text-xl text-white rounded-md transition-colors duration-300 flex items-center justify-center disabled:bg-gray-400 disabled:cursor-default',
